      ...
      <div className="container flex items-center justify-center h-full">
        <div className="grid grid-cols-1 w-[500px]">
          <div className=" flex-col gap-4 text-center flex items-center justify-center">
            <Image src={'https://media.istockphoto.com/id/1214467889/video/the-inscription-404-not-found-makes-a-glitch-system-error-motion-graphics.jpg?s=640x640&k=20&c=bipJvdvw02szLppAnxxrZC602tQJDP3jN-O7svgOLfo='} alt="404" />
